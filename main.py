...
if __name__ == '__main__':
    ...
    # foos = bs.session.query(Master._height, Master._weight, Master._birthYear).order_by(Master._birthYear).all()
    # foos = list(filter(lambda x: not (None in x), foos))
    # foosDataManager = DataManager(foos, ['height', 'weight', 'birthYear'])
    # dv = DataVisualizer()
    # dv.add2dScatter(foosDataManager.d['birthYear'], foosDataManager.d['weight'])
    # dv.setXLabel('birth year')
    # dv.setYLabel('weight / pounds')
    # dv.show()
    ...
    # dv1.setTitle("chronological order of the sum of second base")
    #
    # dv2 = DataVisualizer()
    # dv2.alpha = 1
    ...
    # dv2.setTitle("chronological order of the sum of third base")
    #
    # dv3 = DataVisualizer()
    # dv3.alpha=1
    ...
    # dv3.setTitle("chronological order of the sum of home run")

    # dv4 = DataVisualizer()
    # dv4.add2dScatter(foosDataManager.d['yearID'], foosDataManager.d['2B'])
    # dv4.setXLabel("year")
    # dv4.setYLabel("times the batter reaches second base")
    # dv4.setTitle("chronological order of second base")
    #
    # dv5 = DataVisualizer()
    # dv5.add2dScatter(foosDataManager.d['yearID'], foosDataManager.d['3B'])
    # dv5.setXLabel("year")
    # dv5.setYLabel("times the batter reaches third base")
    # dv5.setTitle("chronological order of third base")
    #
    # dv6 = DataVisualizer()
    # dv6.alpha=0.05
    ...
    # dv6.setTitle("chronological order of home runs")
